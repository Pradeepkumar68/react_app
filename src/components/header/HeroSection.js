  ...
  return (
    ...
    <section className="d-flex align-items-center position-relative z-10">
            <div className="container text-white mt-5">
              ...
              <p className="mt-3 telemark-sub-heading text-start">From the historic telemark canal to the beautiful <br /> coastline in just a few hours</p>
        ...
        <div className="calendar-wrapper container position-absolute start-50 translate-middle-x mb-5">
          <CalenderInput />
        </div>
